  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved rsvp as @rsvp" do
        ...
        post :create, {:rsvp => { "name1" => "invalid value" }}, valid_session
        assigns(:rsvp).should be_a_new(Rsvp)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rsvp" do
        ...
        Rsvp.any_instance.should_receive(:update_attributes).with({ "name1" => "MyString" })
        put :update, {:id => rsvp.to_param, :rsvp => { "name1" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the rsvp as @rsvp" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Rsvp.any_instance.stub(:save).and_return(false)
        put :update, {:id => rsvp.to_param, :rsvp => { "name1" => "invalid value" }}, valid_session
        assigns(:rsvp).should eq(rsvp)
      end
